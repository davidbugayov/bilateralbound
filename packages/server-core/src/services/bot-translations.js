...
const TRANSLATIONS = {
  ...
  welcome_new: {
    ...
    ru:
      '<b>👋 Добро пожаловать в BilateralBound!</b>\n\n' +
      ...
      '🌐 <a href="https://emdrbilateral.online">emdrbilateral.online</a>  ·  <a href="https://emdrbilateral.ru">emdrbilateral.ru</a>',
    es:
      '<b>👋 ¡Bienvenido a BilateralBound!</b>\n\n' +
      ...
      '🌐 <a href="https://emdrbilateral.online">emdrbilateral.online</a>  ·  <a href="https://emdrbilateral.ru">emdrbilateral.ru</a>',
    fr:
      '<b>👋 Bienvenue chez BilateralBound!</b>\n\n' +
      ...
      '🌐 <a href="https://emdrbilateral.online">emdrbilateral.online</a>  ·  <a href="https://emdrbilateral.ru">emdrbilateral.ru</a>',
    de:
      '<b>👋 Willkommen bei BilateralBound!</b>\n\n' +
      ...
      '🌐 <a href="https://emdrbilateral.online">emdrbilateral.online</a>  ·  <a href="https://emdrbilateral.ru">emdrbilateral.ru</a>',
    pt:
      '<b>👋 Bem-vindo ao BilateralBound!</b>\n\n' +
  ...
  already_subscribed: {
    ...
    es:
      '✅ <b>¡La suscripción ya está activa!</b>\n\n' +
      'Vence: {expDate}\n' +
      'Clientes: {clients}\n\n' +
    ...
    de:
      '✅ <b>Abonnement bereits aktiv!</b>\n\n' +
      'Läuft ab: {expDate}\n' +
      'Kunden: {clients}\n\n' +
      'Zurück zur Website — Links sind bereit!',
    pt:
      '✅ <b>Assinatura já está ativa!</b>\n\n' +
      'Expira em: {expDate}\n' +
      'Clientes: {clients}\n\n' +
      'Volte ao site — os links estão prontos!',
    ja:
      '✅ <b>サブスクリプションは既に有効です！</b>\n\n' +
      '期限: {expDate}\n' +
      'クライアント数: {clients}\n\n' +
  ...
  client_linked: {
    en:
      '✅ Client <code>{customId}</code> linked to your account!\n\n' +
      'Go back to the site — links are ready.',
    ru:
      '✅ Клиент <code>{customId}</code> привязан к вашему аккаунту!\n\n' +
      'Возвращайтесь на сайт — ссылки готовы.',
    es:
      '✅ ¡Cliente <code>{customId}</code> vinculado a tu cuenta!\n\n' +
      'Vuelve al sitio — los enlaces están listos.',
    fr:
      '✅ Client <code>{customId}</code> lié à votre compte !\n\n' +
      'Retournez sur le site — les liens sont prêts !',
    de:
      '✅ Kunde <code>{customId}</code> mit Ihrem Konto verknüpft!\n\n' +
      'Zurück zur Website — Links sind bereit!',
    pt:
      '✅ Cliente <code>{customId}</code> vinculado à sua conta!\n\n' +
      'Volte ao site — os links estão prontos!',
    ja:
      '✅ クライアント <code>{customId}</code> がアカウントにリンクされました！\n\n' +
      'サイトに戻ってください — リンクの準備ができています！',
    zh:
  ...
  welcome_short: {
    ...
    es:
      '<b>👋 ¡Bienvenido a BilateralBound Premium!</b>\n\n' +
    ...
    de:
      '<b>👋 Willkommen bei BilateralBound Premium!</b>\n\n' +
    ...
    pt:
      '<b>👋 Bem-vindo ao BilateralBound Premium!</b>\n\n' +
    ...
    ja:
      '<b>👋 BilateralBound Premiumへようこそ！</b>\n\n' +
    ...
    zh:
      '<b>👋 欢迎使用BilateralBound Premium！</b>\n\n' +
      '此机器人管理您的EMDR工具订阅。\n\n' +
      '👉 <b>如何订阅：</b>\n' +
      '1. 前往<a href="{siteUrl}">{siteUrl}</a>\n' +
      '2. 输入客户名称（例如：anna_2025）\n' +
