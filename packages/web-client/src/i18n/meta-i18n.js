...
function updateMetaTags() {
  ...
  if (i18n.isReady) {
    ...
    globalThis.addEventListener('i18nReady', applyTranslationsSafely, {
      once: true
    })
  }
}
...
function init() {
  ...
  globalThis.addEventListener('i18nReady', updateMetaTags)
...
// Export API
globalThis.BBMetaI18n = {
  updateMetaTags,
  init
}

module.exports = { updateMetaTags, init }
