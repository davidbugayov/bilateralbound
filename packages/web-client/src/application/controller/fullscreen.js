...
function wireFullscreenControls() {
  ...
  for (let i = 1; i <= 12; i++) {
    ...
    if (btn)
      btn.onclick = () => _callbacks.setBackgroundColor(bgColors[i - 1])
  }
}
/**
...
module.exports = { initFullscreen, openPreviewFullscreen, closePreviewFullscreen, resizePreviewFullscreen, syncFsPlayPauseButton, updateFullscreenViewerStatus, isFullscreenActive, getFullscreenCanvas }
