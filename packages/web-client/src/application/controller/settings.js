...
function setBallColor(color) {
  ...
  try {
    globalThis.dispatchEvent(
      new CustomEvent('bb_metrika_settings_changed', {
        detail: { setting: 'ballColor', value: color },
      }),
    );
  } catch (e) {
    void e;
...
function setBallSize(size) {
  ...
  try {
    globalThis.dispatchEvent(
      new CustomEvent('bb_metrika_settings_changed', {
        detail: { setting: 'ballSize', value: size },
      }),
    );
  } catch (e) {
    void e;
...
function setSoundEnabled(enabled) {
  ...
  try {
    globalThis.dispatchEvent(
      new CustomEvent('bb_metrika_settings_changed', {
        detail: { setting: 'soundEnabled', value: Boolean(enabled) },
      }),
    );
  } catch (e) {
    void e;
...
function setSoundType(soundType) {
  ...
  try {
    globalThis.dispatchEvent(
      new CustomEvent('bb_metrika_settings_changed', {
        detail: { setting: 'soundType', value: soundType },
      }),
    );
  } catch (e) {
    void e;
...
function setBackgroundColor(color) {
  ...
  try {
    globalThis.dispatchEvent(
      new CustomEvent('bb_metrika_settings_changed', {
        detail: { setting: 'bgColor', value: color },
      }),
    );
  } catch (e) {
    void e;
...
function setIllustration(emoji, btnEl) {
  ...
  document
    .querySelectorAll('.illus-emoji-btn')
