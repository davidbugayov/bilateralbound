  ...
  const structuredData = [
    {
      ...
      description: 'Professional EMDR therapy platform with bilateral stimulation for treating PTSD, anxiety, and trauma',
    ...
    },
    {
      ...
      url: 'https://emdrbilateral.ru/',
      description: 'Free online EMDR therapy platform using bilateral stimulation for therapists and patients treating PTSD, anxiety, and trauma.',
    ...
    },
    {
      ...
      contactPoint: {
        ...
        availableLanguage: [
          ...
          'French', 'Portuguese', 'Japanese', 'Chinese'
        ]
      }
    }
  ]
