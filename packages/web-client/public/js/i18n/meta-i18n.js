  ...
  function updateMetaTags() {
    ...
    const applyTranslationsSafely = () => {
      try {
        ...
        const titleKey = document.documentElement.dataset.titleKey || 'controller.meta.controllerTitle'
        ...
        const looksLikeKey = translated === titleKey ||
          (typeof translated === 'string' && /^([a-z0-9_]+\.)+[a-z0-9_]+$/i.test(translated))
    ...
    if (i18n.isReady) {
      ...
      global.addEventListener('i18nReady', applyTranslationsSafely, { once: true })
    }
  }
