...
## Текущая Версия: v2.98.0
**Статус:** Активна
**Дата релиза:** 22 октября 2025 г. в 10:05
**Коммит:** 2f74374

### Основные Изменения v2.98.0:
- ✨ feat: add session restore from index page
- 🔄 Автоматическое обновление версии
- 🚀 Готов к развертыванию

### Предыдущие Версии:
- **v2.97.0** - Предыдущая версия
...
---
*Автоматически сгенерировано: 2025-10-22T07:05:00.709Z*
