...
**Статус:** Активна
**Дата релиза:** 29 октября 2025 г. в 13:19
**Коммит:** 277802e
### Основные Изменения v1.6.0:
- ✨ 🔧 Исправлен путь к статическим файлам в server-core
- 🔄 Автоматическое обновление версии
- 🚀 Готов к развертыванию
### Предыдущие Версии:
- **v1.5.0** - Предыдущая версия
...
---
*Автоматически сгенерировано: 2025-10-29T10:19:27.999Z*
