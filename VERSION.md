...
## Текущая Версия: v2.88.0
**Статус:** Активна
**Дата релиза:** 19 октября 2025 г. в 16:15
**Коммит:** ef4f578

### Основные Изменения v2.88.0:
- ✨ fix(cors): add production domains to CORS config
- 🔄 Автоматическое обновление версии
- 🚀 Готов к развертыванию

### Предыдущие Версии:
- **v2.87.0** - Предыдущая версия
...
---
*Автоматически сгенерировано: 2025-10-19T13:15:47.285Z*
