...
## Текущая Версия: v5.6.3
**Статус:** Активна
**Дата релиза:** 27 октября 2025 г. в 11:46
**Коммит:** 91a3f07
### Основные Изменения v5.6.3:
- ✨ fix: Update CSP for Yandex.Metrika (yastatic.net)
- 🔄 Автоматическое обновление версии
- 🚀 Готов к развертыванию
### Предыдущие Версии:
- **v5.6.2** - Предыдущая версия
...
---
*Автоматически сгенерировано: 2025-10-27T08:46:31.349Z*
