...
## Текущая Версия: v5.6.1
**Статус:** Активна
**Дата релиза:** 27 октября 2025 г. в 11:34
**Коммит:** 92c5dbf
### Основные Изменения v5.6.1:
- ✨ fix: Replace custom Yandex.Metrika script with standard one
- 🔄 Автоматическое обновление версии
- 🚀 Готов к развертыванию
### Предыдущие Версии:
- **v5.6.0** - Предыдущая версия
...
---
*Автоматически сгенерировано: 2025-10-27T08:34:41.257Z*
