...
## Текущая Версия: v2.36.1
**Статус:** Активна
**Дата релиза:** 9 октября 2025 г. в 13:24
**Коммит:** 10229ee

### Основные Изменения v2.36.1:
- ✨ test: verify all webhooks are working
...
---
*Автоматически сгенерировано: 2025-10-09T10:24:31.810Z*
