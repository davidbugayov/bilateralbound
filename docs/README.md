...
Полная документация EMDR Bilateral Platform - профессиональной платформы для EMDR-терапии с билатеральной стимуляцией.
...
### 3️⃣ Деплой
```bash
npm run deploy:dev   # Деплой на dev окружение
...
- **Панель хостинга:** https://cp.beget.com
