...
(function() {
    ...
    function trackPageView() {
        if (metrikaInitiated && window.ym) {
            try {
                ...
                console.log('✅ Страница засчитана в Яндекс.Метрике');
            } catch (error) {
    ...
    function debugMetrika() {
        ...
        console.log('- Загружен:', metrikaLoaded);
        console.log('- Инициализирован:', metrikaInitiated);
        console.log('- window.ym доступен:', typeof window.ym !== 'undefined');
        ...
        track: function(params) {
            if (metrikaInitiated && window.ym) {
                try {
                    ...
                    console.log('✅ Событие отправлено в Яндекс.Метрику:', params.event);
                } catch (error) {
