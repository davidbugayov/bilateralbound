...
**Последнее обновление:** 15.01.2026 - 🎯 Исправление центрирования мяча при загрузке viewer

**🎉 ОПТИМИЗАЦИЯ ПРОИЗВОДИТЕЛЬНОСТИ И UX (15.01.2026)**:
- ✅ **Исправлено центрирование мяча** - мяч теперь всегда в центре при загрузке без контроллера
- ✅ **Неблокирующая кнопка звука** - кнопка "🔊 Включить звук" внизу экрана, не блокирует движение
